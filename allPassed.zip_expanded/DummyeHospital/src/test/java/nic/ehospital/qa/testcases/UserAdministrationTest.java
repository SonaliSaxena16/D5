...
import nic.ehospital.qa.pages.UserAdministration;
import nic.ehospital.qa.util.TestUtil;

public class UserAdministrationTest extends TestBase{
	...
	public UserAdministrationTest() throws IOException {
		super();
	}
	...
	public void userAdministrationLinkIsDisplayed() throws IOException, InterruptedException{
		userAdmin = new UserAdministration();
