...
//compiler finds error in i/0 tries to throw exception but correct exception not found.Hence exception wud not be caught still it'll execute finally block
		System.out.println("Inside catch block");
		System.out.println("In java no nmbr can be divide by zero");
	}
	finally
